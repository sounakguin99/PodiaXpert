    ...
    <section className="bg-red-600 py-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">
          Ready to Take the First Step Towards Pain-Free Walking?
        </h2>
        <p className="text-red-100 text-lg mb-10 max-w-2xl mx-auto">
          Whether you're struggling with heel pain, plantar fasciitis, flat feet, diabetic foot concerns, or general foot discomfort, we're here to help.
        </p>
