                  ...
                  <div className="flex gap-4 items-start text-left">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm leading-relaxed mt-1">
                        Block BA47, 1929, Rajdanga Main Road, Sarat Park,
                        Naskarhat, East Kolkata Twp, Kolkata, West Bengal
                        700107{" "}
                      </p>
                    </div>
                  </div>
                ...
                <div className="p-8 md:p-10">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <select className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none transition bg-slate-50 text-gray-600 appearance-none bg-[url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%22292.4%22%20height%3D%22292.4%22%3E%3Cpath%20fill%3D%22%23131313%22%20d%3D%22M287%2069.4a17.6%2017.6%200%200%200-13-5.4H18.4c-5%200-9.3%201.8-12.9%205.4A17.6%2017.6%200%200%200%200%2082.2c0%205%201.8%209.3%205.4%2012.9l128%20127.9c3.6%203.6%207.8%205.4%2012.8%205.4s9.2-1.8%2012.8-5.4L287%2095c3.5-3.5%205.4-7.8%205.4-12.8%200-5-1.9-9.2-5.5-12.8z%22%2F%3E%3C%2Fsvg%3E')] bg-[length:12px_12px] bg-no-repeat bg-[position:right_1.2rem_center]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              We provide state-of-the-art foot diagnostics and customized
              orthotics designed to relieve your foot pain and restore natural
              mobility.
            </p>
          </div>
          ...
          <div className="bg-slate-50 rounded-3xl p-8 md:p-12 border border-gray-100 text-center max-w-4xl mx-auto relative overflow-hidden">
            <div className="relative z-10">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                Your Journey to Pain-Free Walking Starts Here
              </h3>
              <p className="text-gray-600 text-lg leading-relaxed mb-6">
                At PodiaXpert, we are committed to helping you move comfortably
                and confidently with specialised foot care, custom insoles and
                mobility solutions.
              </p>
