      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-gray-600">
            We provide state-of-the-art foot diagnostics and customized orthotics designed to relieve your foot pain and restore natural mobility.
          </p>
        </div>
        ...
        <div className="bg-white rounded-3xl p-8 md:p-10 shadow-lg border border-gray-100 text-center max-w-4xl mx-auto relative overflow-hidden">
          <div className="relative z-10">
            <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">Your Journey to Pain-Free Walking Starts Here</h3>
