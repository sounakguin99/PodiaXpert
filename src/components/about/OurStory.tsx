      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-emerald-800 font-semibold mb-0 leading-relaxed text-base border-l-4 border-emerald-500 pl-4 bg-emerald-50/50 py-3 rounded-r-xl">
              Our goal is simple – to help you walk pain-free, stay active and enjoy everyday life with confidence.
            </p>
          </div>
        ...
        <div className="mt-20 pt-20 border-t border-gray-100">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Choose PodiaXpert?</h2>
            <p className="text-gray-600">We offer specialized care, state-of-the-art diagnostics, and personalized treatment plans to help you live a pain-free life.</p>
          </div>
